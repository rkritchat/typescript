...
//Normal function
var add1 = function (a, b) { return a + b; }; //a and b can be any value
...
var add2 = function (a, b) { return a + b; }; // a and b can be number only * if not number system will compile pass with warnning
...
var add3 = function (a, b, c) { return a + b + (c ? c : 0); }; //When we need to use optional, just put ? end of parameter
